...
def prepare_data(data_dir, batch_size): 
    ...
    logging.info(f"There are {len(full_dataset)} images and {num_classes} classes.")
...
def main():
    ...
    train_loader, val_loader, class_weights = prepare_data(args.data_dir, args.batch_size)
